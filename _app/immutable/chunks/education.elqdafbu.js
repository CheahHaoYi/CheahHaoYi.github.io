import{A as n}from"./assets.Dnpk_tvS.js";const e=`# Ridge View Residential College (RVRC)
...
- **RVC1000**: How in the World Do We Get Along?`,i=`# Technical University of Denmark (DTU)
...
`,t=`# National University of Singapore (NUS)
...
`,a="Education",o=[{degree:"Bachelor of Engineering (Honours)",description:t,location:"Singapore",logo:n.NUS,name:"National University of Singapore",organization:"NUS",period:{from:new Date(2021,8,1),to:new Date(2025,5,1)},shortDescription:"Computer Engineering",slug:"National University of Singapore",subjects:["ALgorithm","C/C++","Python","Java","Verilog","Assembly"]},{degree:"Exchange Programme",description:i,location:"Denmark",logo:n.DTU,name:"Techical University of Denmark",organization:"DTU",period:{from:new Date(2024,0,1),to:new Date(2024,5,1)},shortDescription:"Semester long exchange programme",slug:"Danmarks Tekniske Universitet",subjects:["Reinforcement Learning","VLSI","Sustainable Economics"]},{degree:"Residential College Programme",description:e,location:"Singapore",logo:n.RVRC,name:"Ridge View Residential College",organization:"RVRC",period:{from:new Date(2021,8,1),to:new Date(2025,5,1)},shortDescription:"Sustainability Studies",slug:"Ridge View Residential College",subjects:["Cultures and Connection","Communities and Engagement","Singapore Studies","Sustainability"]}],s={title:a,items:o};export{s as E};
